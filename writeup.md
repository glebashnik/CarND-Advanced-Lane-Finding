...
The project is implemented in Jupyter notebook "advanced_lane_finding.py". Project steps are marked with appropriate subtitles and intermediate steps for all test images are vidualized inside the notebook. This writeup will include sample images for each step. 
...
![alt text](output_images/undist_chessboard.png "Logo Title Text 1")
